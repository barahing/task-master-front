...
function LabelCheckboxComponent() {
  ...
  <div>
    <div class="flex w-max gap-6">
      ...
      <div class="inline-flex items-center">
        ...
        <input
          type="checkbox"
          class="border-black before:content[''] peer relative h-4 w-4 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-red-500 checked:bg-red-500 checked:before:bg-red-500 hover:before:opacity-10"
          id="checkbox-2"
  ...
  <div class="inline-flex items-center">
    ...
    <p className="text-xs">Familiar</p>
  </div>
  </div>
  <div class="flex w-max gap-6">
  <div class="inline-flex items-center">
    ...
    <p className="text-xs">Negocios</p>
  </div>
  <div class="inline-flex items-center">
    <label
      class="relative flex cursor-pointer items-center rounded-full p-3"
